...
public class Autonomous extends SequentialCommandGroup
{
    ...
    public Autonomous(Drivetrain drivetrain, String routine_name){
        ...
        createRoutine("myRoutine", my_auto_drive.getPathGroupCommand("foward").andThen(new InstantCommand(() -> {System.out.println("test!");})).andThen(my_auto_drive.getPathGroupCommand("back")));
